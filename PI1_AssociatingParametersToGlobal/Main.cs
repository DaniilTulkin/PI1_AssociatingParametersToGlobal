...
namespace PI1_AssociatingParametersToGlobal
{
    ...
    public class Main : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication application)
        {
            ...
            {
                Label = "Связать параметр\nс глобальным",
                Panel = ribbonPanel,
                ToolTip = "Связывает предварительно созданный глобальный параметр с выбранным параметром выбранного семейства",
                CommandNamespacePath = Command.GetPath(),
                ImageName = "icon_PI1_AssociatingParametersToGlobal_16x16.png",
                LargeImageName = "icon_PI1_AssociatingParametersToGlobal_32x32.png"
            };
